  ...
  properties: {
    ...
    operations: {
      ...
      items: {
        type: "object",
        additionalProperties: false,
        required: ["action", "index", "field", "slot", "itemId", "mobType", "enchantId", "effectId", "value", "count", "level", "durationSeconds", "dropChance", "material", "pattern", "color", "target", "potionType", "potionModifier", "shape", "colors", "fadeColors", "trail", "twinkle"],
        properties: {
          action: { type: "string" },
          ...
          mobType: { type: ["string", "null"] },
          enchantId: { type: ["string", "null"] },
          ...
          dropChance: { type: ["number", "null"] },
          material: { type: ["string", "null"] },
          pattern: { type: ["string", "null"] },
          color: { type: ["string", "null"] },
          target: { type: ["string", "null"] },
          potionType: { type: ["string", "null"] },
          potionModifier: { type: ["string", "null"] },
          shape: { type: ["string", "null"] },
          colors: { type: ["array", "null"], items: { type: "string" } },
          fadeColors: { type: ["array", "null"], items: { type: "string" } },
          trail: { type: ["boolean", "null"] },
          twinkle: { type: ["boolean", "null"] },
        },
      },
    },
  },
