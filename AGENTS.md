# mc-commands
  ...
  - После завершения работы всегда предлагать пользователю merge в ветку `main` и отправку изменений в `origin`; выполнять merge или push только после явного подтверждения пользователя.
